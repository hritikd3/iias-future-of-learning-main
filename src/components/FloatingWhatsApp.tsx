...
const WHATSAPP_NUMBER = "919174171579";
...
export function FloatingWhatsApp() {
    ...
    // Auto-show tooltip after 8 seconds, once per session
    useEffect(() => {
    ...
    return (
        // Positioned to sit just to the left of the ChatBot (right-6 + 14 = right-24)
        <div className="fixed bottom-6 right-24 z-[90] flex flex-col items-end gap-3">

            {/* Tooltip Card — opens above the button */}
            <AnimatePresence>
                {isTooltipOpen && (
                    <motion.div
                        ...
                        className="relative bg-[#0f0f0f] border border-white/10 rounded-2xl p-5 w-72 shadow-2xl shadow-black/60 mb-2"
                    >
                        {/* Close */}
                        <button
                        ...
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center shrink-0 shadow-lg shadow-green-500/30">
                        ...
                        <p className="text-gray-300 text-sm leading-relaxed mb-4">
                            Get instant answers about our courses, fees &amp; admissions. Fast response guaranteed!
                        </p>
                        ...
                        {/* Arrow pointing down */}
                        <div className="absolute -bottom-[7px] right-6 w-3.5 h-3.5 bg-[#0f0f0f] border-b border-r border-white/10 rotate-45" />
                    </motion.div>
                )}
            </AnimatePresence>
